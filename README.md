...
- `cpp/barnsley_fern_claim_wave.cpp`: C++ claim-wave card that treats Barnsley growth as a novelty-front problem, highlighting which coarse cells are genuinely new in each interval and where that remaining claim front sits in the fern
...
### Barnsley fern claim wave

![Barnsley fern claim wave](art/barnsley-fern-claim-wave.png)
...
c++ -O2 -std=c++17 cpp/barnsley_fern_claim_wave.cpp -o /tmp/barnsley_fern_claim_wave
/tmp/barnsley_fern_claim_wave art/barnsley-fern-claim-wave.svg art/barnsley-fern-claim-wave.csv

cc -O2 -std=c11 c/rule30_damage_cone_svg.c -o /tmp/rule30_damage_cone_svg
/tmp/rule30_damage_cone_svg art/rule30-damage-cone.svg art/rule30-damage-cone.csv
```
